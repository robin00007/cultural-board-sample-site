...
//     if(x==0){document.getElementById("event-names").style.display="inline-block";x=1;
//      }
//     else if(x==1){document.getElementById("event-names").style.display="none";x=0;}
